...
public class CrudJava extends JFrame {
    ...
    public void Connect()
    {
        try {
            ...
            con = DriverManager.getConnection("jdbc:mariadb://localhost/gbproducts", "root","");
    ...
    public static void main(String[] args) {
        JFrame frame = new JFrame("CrudJava");
        frame.setContentPane(new CrudJava().panel1);
